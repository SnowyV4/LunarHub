...
TextLabel2.Text = "Welcome to VenexHub V2!"
...
dupeee.Text = "Duplicate Huges 2x"
...
TextLabel_3.Text = "NEW BETA, please report bugs to Venex!"
...
TextLabel_5.Text = "made by Venex"
